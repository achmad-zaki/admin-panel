const Breadcrumb = ({ label }) => {
    return (
        <div className='flex flex-col justify-between items-start md:flex-row md:items-center'>
            <h1 className='text-2xl md:text-4xl font-bold mb-3 text-dark'>{label}</h1>
            <nav className="mb-5 w-min flex px-5 py-3 text-black border border-dark/30 rounded-lg" aria-label="Breadcrumb">
